...
class ImagePath {
  ...
  //Splash Items
  static const String AMANDLA_LG = "$imageDir/amandla_lg.png";
  ...
  static const String ISLAND_HAT = "$imageDir/island_hat.png";
  static const String JEANS_JACKET = "$imageDir/jeans_jacket.png";
  static const String GREEN_SHIRT = "$imageDir/green_shirt.png";
  static const String RED_SHIRT = "$imageDir/red_shirt.png";
  static const String HIGH_HEELS = "$imageDir/high_heels.png";
  ...
  static const String SEAN_OPRY_HM_LG = "$imageDir/sean-opry-hm-lg.png";
